"""
- try random implemntation of contrasting over scratch images
...
OUT_ROOT = "/shared/rc/defgengan/outputs/exp4_normal_vs_scratch"
...
# ENHANCEMENT
# =========================================================
def enhance_scratch_pil(img_pil):
    enhanced = img_pil.filter(ImageFilter.SHARPEN)
...
def load_and_preprocess_tf(path, label):
    ...
    # Apply scratch enhancement only to scratch class
    if label_int == 1:
        img = enhance_scratch_pil(img)
